                          ...
                          <!--   <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="" class="form-group">
                                  ...
                                  <!--    <a  onclick="showBox();" id="send" href="javascript:void(0);" class="btn btn-success">Send SMS </a>-->
									<span style="font-size:30px">Attendance for <?php echo $_GET['session']; ?> Session</span>
									 <br/><br/>
									 <a href="master_sheet" class="btn btn-primary" >Go back </a>
									  <a href="printattendance?session=<?php echo $_GET['session']; ?>" class="btn btn-success">Print </a>
