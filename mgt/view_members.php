      ...
      <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">View Information</div>
 ...
 <div class="col-sm-12 controls">
  ...
  <tbody>
   ...
   <tr>
      ...
      <td  style="font-weight:20px;font-size:30px"><b><?php echo ucwords($row['prefname']); ?></b></td>
   ...
   <tr>
      ...
      <td><b>Address:</b> <?php echo ucwords($row['address']); ?></td>
    ...
    <tr>
      ...
      <td><b>Location: </b><?php echo ucwords($row['city']); ?>,<?php echo ucwords($row['state']); ?></td>
    ...
    <tr>
      ...
      <td style="color:#090"><b>Session:</b> <?php echo ucwords($row['session']); ?></td>
    ...
    <tr>
      ...
      <td colspan="2"><b style="color:#ff0000">Employment Information</b></td>
    ...
    <tr>
      ...
      <td style="font-weight:20px;font-size:15px"><b> Title:</b> <?php echo ucwords($row['title']); ?></td>
    ...
    <tr>
      ...
      <td><b>Ministry:</b> <?php echo ucwords($row['ministry']); ?></td>
    ...
    <tr>
      ...
      <td><b>Work  Location:</b><?php echo ucwords($row['worklocation']); ?></td>
    ...
    <tr>
      ...
      <td><b>Work Phone:</b> <?php echo ucwords($row['workphone']); ?></td>
   ...
   <tr>
      ...
      <td colspan="2"><b style="color:#ff0000">Emergency Contact Information</b></td>
   ...
   <tr>
      ...
      <td><b>Fullname:</b><?php echo ucwords($row['elastname']); ?> <?php echo ucwords($row['efirstname']); ?></td>
    ...
    <tr>
      ...
      <td><b>Address:</b><?php echo ucwords($row['eaddress']); ?> <?php echo ucwords($row['efirstname']); ?></td>
    ...
    <tr>
      ...
      <td><b>Location:</b><?php echo ucwords($row['ecity']); ?> <?php echo ucwords($row['estate']); ?></td>
   ...
   <tr>
      ...
      <td><b>Relationship:</b><?php echo ucwords($row['erelationship']); ?></td>
