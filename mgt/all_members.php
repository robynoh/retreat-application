                          ...
                          <!--   <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="" class="form-group">
                                  ...
                                  <!--    <a  onclick="showBox();" id="send" href="javascript:void(0);" class="btn btn-success">Send SMS </a>-->
									 ...
									 <a href="feedbacks" class="btn btn-success" >Feedbacks </a>
									  <a href="attenders" class="btn btn-primary" >Attendance </a>
									    <a href="sendsms" class="btn btn-primary" >Send SMS </a>
									  <br/> <br/>
									 <form id="loginform" action="session_sort" class="form-horizontal" role="form" method="GET">
									 <b>Sort by Session</b> <select name="session" style="height:30px"><option>Morning</option><option>Afternoon</option><option>Evening</option></select><button class="btn btn" >Go </button>
									 </form>
