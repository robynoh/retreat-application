      ...
      <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title">Attendance sheet</div>
                          ...
                          <!--   <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="" class="form-group">
                                  ...
                                  <!--    <a  onclick="showBox();" id="send" href="javascript:void(0);" class="btn btn-success">Send SMS </a>-->
									 <a href="attenders" class="btn btn-primary" >Go back </a>
									 
									  <br/> <br/>
									 <form id="loginform" action="master_attendance_sheet" class="form-horizontal" role="form" method="GET">
									 <b>Choose Session</b> <select name="session" style="height:30px"><option>Morning</option><option>Afternoon</option><option>Evening</option></select><button class="btn btn" >View Attendance </button>
									 </form>
