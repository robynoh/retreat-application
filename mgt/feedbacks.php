...
$sql="SELECT * FROM feedback order by id DESC limit $offset, $recordperpage";
...
<div style="text-align:center;font-weight:bold">
	...
	<?php if(mysqli_num_rows($results)>0){ 
	 ...
	 $connect->Pages_admin("SELECT COUNT(id) AS numrows FROM `feedback`  ",$recordperpage,$pagenum,"feedbacks?get");?>
 ...
 <div style="text-align:center;color:#ff0000;font-weight:bold"> <?php echo $msg; ?></div>
                          ...
                          <!--   <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
									 ...
									 <a href="all_members" class="btn btn-success" >All members </a>
  ...
  <?php foreach($rows as $row){ ?>
    ...
    <tr><a href="">
	  ...
	  <td> </td>
	  <td><a href="view_feedback?id=<?php echo $row['id'] ?>">View feedback</a></td>
   </a> </tr>
